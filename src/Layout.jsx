          ...
          return (
            <button
              ...
              className={`flex-1 flex flex-col items-center justify-center min-h-[56px] gap-0.5 transition-all duration-200 select-none rounded-2xl ${
                active
                  ? "bg-gradient-to-r from-violet-600 to-indigo-600 text-white dark:text-violet-400 dark:bg-none dark:from-transparent dark:to-transparent dark:bg-slate-900 shadow-md shadow-violet-500/20"
