  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:bg-none dark:bg-slate-950" role="region" aria-label="Settings page">
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 py-12">
        ...
        >
          <button
            onClick={() => { localStorage.removeItem('base44_from_url'); localStorage.removeItem('base44_from__url'); base44.auth.logout(); setTimeout(() => { window.location.replace(window.location.origin + '/?cache_bust=' + Date.now()); }, 100); }}
