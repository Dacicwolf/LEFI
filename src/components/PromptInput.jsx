...
export default function PromptInput({ prompt, setPrompt, onGenerate, isLoading }) {
  ...
  return (
    ...
    >
      <div className="border border-transparent focus-within:border-[#cccccc] rounded-2xl bg-white dark:bg-slate-900 shadow-xl shadow-slate-200/50 dark:shadow-black/30 transition-colors overflow-hidden">
        <textarea
          ...
          className="w-full bg-transparent text-base text-slate-800 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 border-0 p-4"
        />
